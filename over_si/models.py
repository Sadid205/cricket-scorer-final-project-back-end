...
class OverSI(models.Model):
    ball = models.ManyToManyField('balls.Balls',related_name='over_si',blank=True)
    bowler = models.ForeignKey('bowler.Bowler',related_name='overs_si',null=True,blank=True,on_delete=models.CASCADE)
