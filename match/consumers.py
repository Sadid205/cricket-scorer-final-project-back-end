...
async def update_score(existing_match,panalty,scored_runs,panalty_runs,swap_batsman,retired_batsman,replaced_batsman,toss_winner,host_team,visitor_team,elected,wicket,wide,no_ball,byes,legByes,how_wicket_fall,run,new_batsman,who_helped,innings):
        ...
        if wicket==True and (wide==True or no_ball==True or byes==True or legByes==True):
            ...
            if toss_winner == host_team and elected=="Bat" or toss_winner==visitor_team and elected=="Bowl":
                batting_team = host_team if innings=="1st" else visitor_team
                bowling_team = visitor_team if innings=="1st" else host_team
                if wide==True and (how_wicket_fall=="run_out_striker" or how_wicket_fall=="run_out_non_striker"):
                    await wide_and_wicket(existing_match=existing_match,run=run,how_wicket_fall=how_wicket_fall,existing_batsman=existing_batsman,existing_over_instance=existing_over_instance,ball_types="WD&RO",runs="OUT",batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,wide=wide,no_ball=no_ball,innings=innings,who_helped=who_helped)
                elif wide==True and how_wicket_fall=="stumping":
                    await wide_and_wicket(existing_match=existing_match,run=run,how_wicket_fall=how_wicket_fall,existing_batsman=existing_batsman,existing_over_instance=existing_over_instance,ball_types="WD&S",runs="OUT",batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,wide=wide,no_ball=no_ball,innings=innings,who_helped=who_helped)
                elif wide==True and how_wicket_fall=="hit_wicket":
                    await wide_and_wicket(existing_match=existing_match,run=run,how_wicket_fall=how_wicket_fall,existing_batsman=existing_batsman,existing_over_instance=existing_over_instance,ball_types="WD&HW",runs="OUT",batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,wide=wide,no_ball=no_ball,innings=innings,who_helped=who_helped)
                elif no_ball==True and how_wicket_fall=="bowled":
                    await wide_and_wicket(existing_match=existing_match,run=run,how_wicket_fall=how_wicket_fall,existing_batsman=existing_batsman,existing_over_instance=existing_over_instance,ball_types="NO&B",runs="OUT",batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,wide=wide,no_ball=no_ball,innings=innings,who_helped=who_helped)
                elif no_ball==True and how_wicket_fall=="catch_out":
                    await wide_and_wicket(existing_match=existing_match,run=run,how_wicket_fall=how_wicket_fall,existing_batsman=existing_batsman,existing_over_instance=existing_over_instance,ball_types="NO&CO",runs="OUT",batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,wide=wide,no_ball=no_ball,innings=innings,who_helped=who_helped)
                elif no_ball==True and (how_wicket_fall=="run_out_striker" or how_wicket_fall=="run_out_non_striker"):
                    await wide_and_wicket(existing_match=existing_match,run=run,how_wicket_fall=how_wicket_fall,existing_batsman=existing_batsman,existing_over_instance=existing_over_instance,ball_types="NO&RO",runs="OUT",batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,wide=wide,no_ball=no_ball,innings=innings,who_helped=who_helped)
                elif no_ball==True and how_wicket_fall=="stumping":
                    await wide_and_wicket(existing_match=existing_match,run=run,how_wicket_fall=how_wicket_fall,existing_batsman=existing_batsman,existing_over_instance=existing_over_instance,ball_types="NO&S",runs="OUT",batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,wide=wide,no_ball=no_ball,innings=innings,who_helped=who_helped)
                elif no_ball==True and how_wicket_fall=="lbw":
                    await wide_and_wicket(existing_match=existing_match,run=run,how_wicket_fall=how_wicket_fall,existing_batsman=existing_batsman,existing_over_instance=existing_over_instance,ball_types="NO&LBW",runs="OUT",batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,wide=wide,no_ball=no_ball,innings=innings)
                elif no_ball==True and how_wicket_fall=="hit_wicket":
                    await wide_and_wicket(existing_match=existing_match,run=run,how_wicket_fall=how_wicket_fall,existing_batsman=existing_batsman,existing_over_instance=existing_over_instance,ball_types="NO&HW",runs="OUT",batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,wide=wide,no_ball=no_ball,innings=innings,who_helped=who_helped)
                elif (byes==True or legByes==True) and (how_wicket_fall=="run_out_striker" or how_wicket_fall=="run_out_non_striker"):
                    if byes==True:
                        await wide_and_wicket(existing_match=existing_match,run=run,how_wicket_fall=how_wicket_fall,existing_batsman=existing_batsman,existing_over_instance=existing_over_instance,ball_types="BYE&RO",runs="OUT",batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,wide=wide,no_ball=no_ball,innings=innings,who_helped=who_helped)
                    else:
                        await wide_and_wicket(existing_match=existing_match,run=run,how_wicket_fall=how_wicket_fall,existing_batsman=existing_batsman,existing_over_instance=existing_over_instance,ball_types="LGB&RO",runs="OUT",batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,wide=wide,no_ball=no_ball,innings=innings,who_helped=who_helped)
                elif (byes==True or legByes==True) and (how_wicket_fall=="stumping"):
                    if byes==True:
                        await wide_and_wicket(existing_match=existing_match,run=run,how_wicket_fall=how_wicket_fall,existing_batsman=existing_batsman,existing_over_instance=existing_over_instance,ball_types="BYE&S",runs="OUT",batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,wide=wide,no_ball=no_ball,innings=innings,who_helped=who_helped)
                    else:
                        await wide_and_wicket(existing_match=existing_match,run=run,how_wicket_fall=how_wicket_fall,existing_batsman=existing_batsman,existing_over_instance=existing_over_instance,ball_types="LGB&S",runs="OUT",batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,wide=wide,no_ball=no_ball,innings=innings,who_helped=who_helped)
                elif (byes==True or legByes==True) and (how_wicket_fall=="hit_wicket"):
                    if byes==True:
                        await wide_and_wicket(existing_match=existing_match,run=run,how_wicket_fall=how_wicket_fall,existing_batsman=existing_batsman,existing_over_instance=existing_over_instance,ball_types="BYE&HW",runs="OUT",batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,wide=wide,no_ball=no_ball,innings=innings,who_helped=who_helped)
                    else:
                        await wide_and_wicket(existing_match=existing_match,run=run,how_wicket_fall=how_wicket_fall,existing_batsman=existing_batsman,existing_over_instance=existing_over_instance,ball_types="LGB&HW",runs="OUT",batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,wide=wide,no_ball=no_ball,innings=innings,who_helped=who_helped)
                else:
        ...
        if wicket==True:
            ...
            if toss_winner == host_team and elected=="Bat" or toss_winner==visitor_team and elected=="Bowl":
                ...
                if how_wicket_fall=="bowled":
                    await wicket_function(existing_match=existing_match,existing_striker_or_non_striker=existing_striker,batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,how_wicket_fall=how_wicket_fall,ball_types="BO",runs="0",innings=innings,who_helped=who_helped)
                if how_wicket_fall=="catch_out":
                    await wicket_function(existing_match=existing_match,existing_striker_or_non_striker=existing_striker,batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,how_wicket_fall=how_wicket_fall,ball_types="CO",runs="0",innings=innings,who_helped=who_helped)
                if how_wicket_fall=="run_out_striker":
                    await wicket_function(existing_match=existing_match,existing_striker_or_non_striker=existing_striker,batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,how_wicket_fall=how_wicket_fall,ball_types="RO",runs="0",innings=innings,who_helped=who_helped)
                if how_wicket_fall=="run_out_non_striker":
                ...
                if how_wicket_fall=="stumping":
                    await wicket_function(existing_match=existing_match,existing_striker_or_non_striker=existing_striker,batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,how_wicket_fall=how_wicket_fall,ball_types="S",runs="0",innings=innings,who_helped=who_helped)
                if how_wicket_fall=="lbw":
                    await wicket_function(existing_match=existing_match,existing_striker_or_non_striker=existing_striker,batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,how_wicket_fall=how_wicket_fall,ball_types="LBW",runs="0",innings=innings,who_helped=who_helped)   
                if how_wicket_fall=="hit_wicket":
                    await wicket_function(existing_match=existing_match,existing_striker_or_non_striker=existing_striker,batting_team=batting_team,bowling_team=bowling_team,new_batsman=new_batsman,how_wicket_fall=how_wicket_fall,ball_types="HW",runs="0",innings=innings,who_helped=who_helped)     
            else:
                batting_team = visitor_team if innings=="1st" else host_team
                bowling_team = host_team if innings=="1st" else visitor_team
                if how_wicket_fall=="bowled":
